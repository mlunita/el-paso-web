  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8 border-b border-white/20 pb-4">
        ...
        <Link href="/hq/staff/create" className="bg-[#a67c52] hover:bg-[#956e47] text-white py-2 px-4 rounded-lg font-bold transition-colors">Add Staff Member</Link>
      </div>
              ...
              <TableRow key={member.id} className="border-white/10 hover:bg-white/5">
                ...
                <TableCell>
                  <div className="flex gap-2">
                    <Link href={`/hq/staff/edit/${member.id}`} className="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium rounded-md shadow-sm">Edit</Link>
