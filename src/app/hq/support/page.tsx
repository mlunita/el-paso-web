                ...
                <TableRow key={category.id} className="border-white/10 hover:bg-white/5">
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      <Link href={`/hq/support/categories/edit/${category.id}`} className="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium rounded-md shadow-sm">
                        Edit
                      </Link>
            ...
            <TableBody>
              ...
              {entries.map((entry) => (
                <TableRow key={entry.id} className="border-white/10 hover:bg-white/5">
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      <Link href={`/hq/support/entries/edit/${entry.id}`} className="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium rounded-md shadow-sm">
                        Edit
                      </Link>
