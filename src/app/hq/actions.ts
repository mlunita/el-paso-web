...
import { requireAdminSession, destroyAdminSession } from "@/lib/auth";
...
export async function updateBanRequestStatus(
  ...
  revalidatePath(`/hq/ban-requests/${id}`);
  revalidatePath("/mod");
  revalidatePath("/hq");
}
...
// =====================================================
// Admin Token Management (from UI)
// =====================================================

export async function revokeAdminToken(id: string) {
  await requireAdminSession();
  ...
  revalidatePath("/hq/admin-tokens");
  revalidatePath("/hq");
}

export async function reactivateAdminToken(id: string) {
  await requireAdminSession();
