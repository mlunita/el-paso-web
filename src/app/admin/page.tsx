...
export default async function AdminDashboard() {
  const [userCount, postCount, applicationCount, staffCount] = await Promise.all([
    prisma.user.count(),
    prisma.post.count(),
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-[#8b5cf6] border-0 text-white p-6 rounded-2xl flex flex-col items-center justify-center">
        ...
        <Card className="bg-[#2dd4bf] border-0 text-white p-6 rounded-2xl flex flex-col items-center justify-center">
